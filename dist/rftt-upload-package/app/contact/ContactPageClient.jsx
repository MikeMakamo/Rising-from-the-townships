...
export default function ContactPageClient({
  ...
  useEffect(() => {
    if (!requestedSubject && !requestedEntrepreneur) {
      return;
    }

    const bookingMessage = requestedEntrepreneur
      ? `I would like to book ${requestedEntrepreneur}${
          requestedCompany ? ` from ${requestedCompany}` : ''
        }. Please share availability, engagement formats, and booking requirements.`
      : '';

    setForm((prev) => ({
      ...prev,
      subject: requestedSubject || prev.subject,
      message: bookingMessage || prev.message,
    }));
  }, [requestedCompany, requestedEntrepreneur, requestedSubject]);
      ...
      <section className="relative bg-brand-dark overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-2xl leading-relaxed">
            Rising from the Township (RFTT) &mdash; whether you have a question, a
            partnership proposal, or a booking enquiry, we would love to hear from you.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-gray-mid text-sm leading-relaxed">
                      79 The Broads Street, Mulbarton,
                      <br />
                      Johannesburg South
                    </p>
                  </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm border border-gray-100">
                ...
                {requestedEntrepreneur ? (
                  <div className="mb-8 rounded-2xl border border-brand-red/15 bg-brand-red/5 p-5">
                    ...
                    <p className="text-brand-gray-mid text-sm leading-relaxed">
                      Complete the form below and we will follow up on availability,
                      engagement fit, and next booking steps.
                    </p>
                  </div>
                ) : null}
                ...
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-brand-gray-mid">
                      {requestedEntrepreneur
                        ? `Your booking request for ${requestedEntrepreneur} has been received. We will be in touch shortly.`
